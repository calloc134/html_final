...
![レスポンシブ対応](image-15.png)

![レスポンシブ対応2](image-16.png)
...
| chocir:   | - 部活紹介ページの作成(HTML, TailwindCSS) <br> - 部活紹介ページのデザイン(TailwindCSS) <br> - お問い合わせページのデ実装・デザイン(HTML, TailwindCSS)                                                                                                                                                                                                                              |
